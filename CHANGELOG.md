...
## [0.5.0-dcp.3] - 2026-03-11

### Changed
- **Auth**: Added optional auth to init, for public deployment
- Upgraded to fastmcp 3.1.0

### Added
- **ASGI endpoint**: For running with uvicorn

### Removed
- **Completiom**: Not supported by 3.1.0
